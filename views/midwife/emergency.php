...
//use app\models\User;
//
//$this->title = 'Midwife-Emergencies';
//
///** @var $model Feedback **/
//?>
<!--<style>-->
...
<!--                            <div class="title">Feedback ID = --><?php //= $feedback->id ?><!--</div>-->
<!--                            <div class="notification-content">-->
<!--                                <h3>User email - --><?php //=$feedback->email?><!--</h3>-->
<!--                                <b>Message - --><?php //= $feedback->feedback ?><!--</b><br>-->
<!--                            </div>-->
<!--                            <div class="notification-footer">-->
<!--                                <div class="dates">-->
<!--                                    <span class="created-date">Created: --><?php //= $feedback->created_at ?><!--</span><br>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
